...
```PowerShell
 java -cp .\target\Kafka1-1.0-SNAPSHOT-jar-with-dependencies.jar com.rahul.app.CustomConsumer
```
...
```PowerShell
 java -cp .\target\Kafka1-1.0-SNAPSHOT-jar-with-dependencies.jar com.rahul.app.CustomProducer
```
